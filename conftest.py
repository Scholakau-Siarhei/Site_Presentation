...
# 2. pytest - библиотека для создания и выполнения автоматических тестов. Она используется для тестирования кода, написанного на Python, и проверки его корректности.
# 3. logging - библиотека для регистрации сообщений, создания журналов и отслеживания ошибок в приложениях. Она используется для записи сообщений об ошибках и отладочной информации в файлы журналов.
# 4. selenium - библиотека для автоматизации действий веб-браузера. Она используется для создания автоматизированных тестов, скрапинга данных с веб-страниц и других задач, связанных с веб-браузером.
