...
btn_singup_code_of_phone_ukraine = (By.XPATH, '//div[@class="registration"]//span[contains(text(), "Ukraine")]')
...
registration_complete = (By.XPATH, '//div[text()="Вы успешно зарегистрированы! Теперь вы можете войти, используя указанный email и пароль."]')
